...
// One synced practice screen: the studied word up top (with 🔊 right under it and
// its conjugation), Prev/Next side by side, and — below — the example sentences
// for whichever word is on screen (a single ExampleCard, remounted per word).
    ...
    <div className="space-y-6">
      ...
      {examples.length > 0 && (
        <div>
          ...
          <ExampleCard key={currentIdx} examples={examples} language={language} />
        </div>
      )}
    </div>
  )
