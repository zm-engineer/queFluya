...
// Each carries several example sentences (studied form highlighted), shown in
// sync below the conjugation. `be`/`have`/`do` show pronoun conjugations.
const irregularVerbsEn: EssentialSet = {
  slug: 'irregular-verbs-en',
  kind: 'irregular-verbs',
  language: 'EN',
  items: [
    { term: 'be', forms: ['be', 'was/were', 'been'], translation: 'ser / estar', examples: [
    ...
    { term: 'have', forms: ['have', 'had', 'had'], translation: 'tener / haber', examples: [
    ...
    { term: 'do', forms: ['do', 'did', 'done'], translation: 'hacer', examples: [
    ...
    { term: 'go', forms: ['go', 'went', 'gone'], translation: 'ir', examples: [
    ...
    { term: 'get', forms: ['get', 'got', 'gotten'], translation: 'conseguir / obtener', examples: [
    ...
    { term: 'make', forms: ['make', 'made', 'made'], translation: 'hacer / fabricar', examples: [
    ...
    { term: 'say', forms: ['say', 'said', 'said'], translation: 'decir', examples: [
    ...
    { term: 'see', forms: ['see', 'saw', 'seen'], translation: 'ver', examples: [
    ...
    { term: 'come', forms: ['come', 'came', 'come'], translation: 'venir', examples: [
    ...
    { term: 'take', forms: ['take', 'took', 'taken'], translation: 'tomar / coger', examples: [
    ...
    { term: 'know', forms: ['know', 'knew', 'known'], translation: 'saber / conocer', examples: [
    ...
    { term: 'give', forms: ['give', 'gave', 'given'], translation: 'dar', examples: [
    ...
    { term: 'find', forms: ['find', 'found', 'found'], translation: 'encontrar', examples: [
    ...
    { term: 'think', forms: ['think', 'thought', 'thought'], translation: 'pensar', examples: [
    ...
    { term: 'tell', forms: ['tell', 'told', 'told'], translation: 'decir / contar', examples: [
    ...
    { term: 'become', forms: ['become', 'became', 'become'], translation: 'convertirse en', examples: [
    ...
    { term: 'leave', forms: ['leave', 'left', 'left'], translation: 'dejar / irse', examples: [
    ...
    { term: 'feel', forms: ['feel', 'felt', 'felt'], translation: 'sentir', examples: [
    ...
    { term: 'put', forms: ['put', 'put', 'put'], translation: 'poner', examples: [
    ...
    { term: 'bring', forms: ['bring', 'brought', 'brought'], translation: 'traer', examples: [
    ...
    { term: 'begin', forms: ['begin', 'began', 'begun'], translation: 'empezar', examples: [
    ...
    { term: 'keep', forms: ['keep', 'kept', 'kept'], translation: 'mantener / guardar', examples: [
    ...
    { term: 'write', forms: ['write', 'wrote', 'written'], translation: 'escribir', examples: [
    ...
    { term: 'hear', forms: ['hear', 'heard', 'heard'], translation: 'oír', examples: [
      { text: 'I can hear you.', highlight: 'hear', translation: 'Te oigo.' },
      { text: 'I heard a noise.', highlight: 'heard', translation: 'Oí un ruido.' },
    ] },
    { term: 'meet', forms: ['meet', 'met', 'met'], translation: 'conocer / encontrarse', examples: [
    ...
    { term: 'run', forms: ['run', 'ran', 'run'], translation: 'correr', examples: [
    ...
    { term: 'pay', forms: ['pay', 'paid', 'paid'], translation: 'pagar', examples: [
    ...
    { term: 'speak', forms: ['speak', 'spoke', 'spoken'], translation: 'hablar', examples: [
    ...
    { term: 'read', forms: ['read', 'read', 'read'], translation: 'leer', examples: [
    ...
    { term: 'lose', forms: ['lose', 'lost', 'lost'], translation: 'perder', examples: [
    ...
    { term: 'buy', forms: ['buy', 'bought', 'bought'], translation: 'comprar', examples: [
    ...
    { term: 'eat', forms: ['eat', 'ate', 'eaten'], translation: 'comer', examples: [
    ...
    { term: 'drink', forms: ['drink', 'drank', 'drunk'], translation: 'beber', examples: [
    ...
    { term: 'drive', forms: ['drive', 'drove', 'driven'], translation: 'conducir / manejar', examples: [
    ...
    { term: 'sell', forms: ['sell', 'sold', 'sold'], translation: 'vender', examples: [
    ...
    { term: 'teach', forms: ['teach', 'taught', 'taught'], translation: 'enseñar', examples: [
    ...
    { term: 'sleep', forms: ['sleep', 'slept', 'slept'], translation: 'dormir', examples: [
    ...
    { term: 'win', forms: ['win', 'won', 'won'], translation: 'ganar', examples: [
    ...
    { term: 'break', forms: ['break', 'broke', 'broken'], translation: 'romper', examples: [
    ...
    { term: 'understand', forms: ['understand', 'understood', 'understood'], translation: 'entender', examples: [
...
const phrasalVerbsEn: EssentialSet = {
  ...
  language: 'EN',
  items: [
    { term: 'give up', translation: 'rendirse / dejar (un hábito)', examples: [{ text: "Don't give up on your dreams.", highlight: 'give up', translation: 'No renuncies a tus sueños.' }] },
    { term: 'find out', translation: 'averiguar / enterarse', examples: [{ text: 'I need to find out the truth.', highlight: 'find out', translation: 'Necesito averiguar la verdad.' }] },
    { term: 'look for', translation: 'buscar', examples: [{ text: "I'm looking for my keys.", highlight: 'looking for', translation: 'Estoy buscando mis llaves.' }] },
    { term: 'look after', translation: 'cuidar (de)', examples: [{ text: 'Can you look after the kids?', highlight: 'look after', translation: '¿Puedes cuidar a los niños?' }] },
    { term: 'look forward to', translation: 'tener ganas de / esperar con ilusión', examples: [{ text: 'I look forward to the weekend.', highlight: 'look forward to', translation: 'Tengo ganas de que llegue el finde.' }] },
    { term: 'get up', translation: 'levantarse', examples: [{ text: 'I get up at seven.', highlight: 'get up', translation: 'Me levanto a las siete.' }] },
    { term: 'get on', translation: 'subirse (a un transporte) / llevarse bien', examples: [{ text: 'Get on the bus quickly.', highlight: 'Get on', translation: 'Súbete al autobús rápido.' }] },
    { term: 'get off', translation: 'bajarse (de un transporte)', examples: [{ text: 'We get off at the next stop.', highlight: 'get off', translation: 'Nos bajamos en la próxima parada.' }] },
    { term: 'turn on', translation: 'encender', examples: [{ text: 'Turn on the lights, please.', highlight: 'Turn on', translation: 'Enciende las luces, por favor.' }] },
    { term: 'turn off', translation: 'apagar', examples: [{ text: 'Turn off your phone.', highlight: 'Turn off', translation: 'Apaga tu teléfono.' }] },
    { term: 'put on', translation: 'ponerse (ropa)', examples: [{ text: 'Put on your jacket.', highlight: 'Put on', translation: 'Ponte la chaqueta.' }] },
    { term: 'take off', translation: 'quitarse (ropa) / despegar', examples: [{ text: 'Take off your shoes.', highlight: 'Take off', translation: 'Quítate los zapatos.' }] },
    { term: 'pick up', translation: 'recoger / aprender', examples: [{ text: 'Can you pick up some milk?', highlight: 'pick up', translation: '¿Puedes comprar leche?' }] },
    { term: 'come back', translation: 'volver / regresar', examples: [{ text: 'Come back soon!', highlight: 'Come back', translation: '¡Vuelve pronto!' }] },
    { term: 'go on', translation: 'continuar / seguir', examples: [{ text: 'Please go on with your story.', highlight: 'go on', translation: 'Por favor, sigue con tu historia.' }] },
    { term: 'carry on', translation: 'continuar', examples: [{ text: "Carry on, you're doing great.", highlight: 'Carry on', translation: 'Sigue así, lo estás haciendo genial.' }] },
    { term: 'set up', translation: 'montar / configurar', examples: [{ text: 'I set up the new printer.', highlight: 'set up', translation: 'Configuré la impresora nueva.' }] },
    { term: 'work out', translation: 'resolver / hacer ejercicio', examples: [{ text: 'Everything worked out fine.', highlight: 'worked out', translation: 'Todo salió bien.' }] },
    { term: 'run out (of)', translation: 'quedarse sin', examples: [{ text: 'We ran out of coffee.', highlight: 'ran out of', translation: 'Nos quedamos sin café.' }] },
    { term: 'break down', translation: 'averiarse / desmoronarse', examples: [{ text: 'My car broke down.', highlight: 'broke down', translation: 'Mi coche se averió.' }] },
    { term: 'grow up', translation: 'crecer / criarse', examples: [{ text: 'I grew up in Madrid.', highlight: 'grew up', translation: 'Crecí en Madrid.' }] },
    { term: 'hang out', translation: 'pasar el rato', examples: [{ text: "Let's hang out this weekend.", highlight: 'hang out', translation: 'Quedemos este finde.' }] },
    { term: 'give back', translation: 'devolver', examples: [{ text: 'Please give back my book.', highlight: 'give back', translation: 'Por favor, devuélveme mi libro.' }] },
    { term: 'throw away', translation: 'tirar / desechar', examples: [{ text: "Don't throw away that box.", highlight: 'throw away', translation: 'No tires esa caja.' }] },
    { term: 'fill in / fill out', translation: 'rellenar (un formulario)', examples: [{ text: 'Fill in this form, please.', highlight: 'Fill in', translation: 'Rellena este formulario, por favor.' }] },
    { term: 'check in', translation: 'registrarse / facturar', examples: [{ text: 'We check in at 3 pm.', highlight: 'check in', translation: 'Hacemos el check-in a las 3.' }] },
    { term: 'call back', translation: 'devolver la llamada', examples: [{ text: "I'll call back later.", highlight: 'call back', translation: 'Te devuelvo la llamada más tarde.' }] },
    { term: 'wake up', translation: 'despertarse', examples: [{ text: 'I wake up early.', highlight: 'wake up', translation: 'Me despierto temprano.' }] },
  ],
}

// Spanish irregular verbs for English speakers — infinitive with a couple of
// irregular forms. `ser`/`estar`/`tener` show pronoun variety.
const irregularVerbsEs: EssentialSet = {
  slug: 'irregular-verbs-es',
  kind: 'irregular-verbs',
  language: 'ES',
  items: [
    { term: 'ser', forms: ['soy', 'fui', 'sido'], translation: 'to be', examples: [
    ...
    { term: 'estar', forms: ['estoy', 'estuve', 'estado'], translation: 'to be (state/location)', examples: [
    ...
    { term: 'tener', forms: ['tengo', 'tuve', 'tenido'], translation: 'to have', examples: [
    ...
    { term: 'hacer', forms: ['hago', 'hice', 'hecho'], translation: 'to do / to make', examples: [
    ...
    { term: 'ir', forms: ['voy', 'fui', 'ido'], translation: 'to go', examples: [
    ...
    { term: 'poder', forms: ['puedo', 'pude', 'podido'], translation: 'can / to be able to', examples: [
    ...
    { term: 'decir', forms: ['digo', 'dije', 'dicho'], translation: 'to say / to tell', examples: [
    ...
    { term: 'ver', forms: ['veo', 'vi', 'visto'], translation: 'to see', examples: [
    ...
    { term: 'dar', forms: ['doy', 'di', 'dado'], translation: 'to give', examples: [
    ...
    { term: 'saber', forms: ['sé', 'supe', 'sabido'], translation: 'to know (facts)', examples: [
    ...
    { term: 'querer', forms: ['quiero', 'quise', 'querido'], translation: 'to want / to love', examples: [
    ...
    { term: 'venir', forms: ['vengo', 'vine', 'venido'], translation: 'to come', examples: [
    ...
    { term: 'poner', forms: ['pongo', 'puse', 'puesto'], translation: 'to put', examples: [
    ...
    { term: 'salir', forms: ['salgo', 'salí', 'salido'], translation: 'to leave / to go out', examples: [
    ...
    { term: 'traer', forms: ['traigo', 'traje', 'traído'], translation: 'to bring', examples: [
    ...
    { term: 'conocer', forms: ['conozco', 'conocí', 'conocido'], translation: 'to know (people/places)', examples: [
    ...
    { term: 'pedir', forms: ['pido', 'pedí', 'pedido'], translation: 'to ask for / to order', examples: [
    ...
    { term: 'dormir', forms: ['duermo', 'dormí', 'dormido'], translation: 'to sleep', examples: [
    ...
    { term: 'sentir', forms: ['siento', 'sentí', 'sentido'], translation: 'to feel', examples: [
    ...
    { term: 'volver', forms: ['vuelvo', 'volví', 'vuelto'], translation: 'to return', examples: [
    ...
    { term: 'empezar', forms: ['empiezo', 'empecé', 'empezado'], translation: 'to start', examples: [
    ...
    { term: 'oír', forms: ['oigo', 'oí', 'oído'], translation: 'to hear', examples: [
