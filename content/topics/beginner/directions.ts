    ...
    studySections: [
      {
        ...
        vocabulary: [
          ...
          { term: 'behind', translation: 'detrás de' },
          { term: 'on the corner', translation: 'en la esquina' },
          { term: 'at the traffic lights', translation: 'en el semáforo' },
          { term: 'the first street', translation: 'la primera calle' },
          { term: 'the second street', translation: 'la segunda calle' },
          { term: 'here / there', translation: 'aquí / allí' },
          { term: "it's far / close", translation: 'está lejos / cerca' },
          { term: 'Is it far?', translation: '¿Está lejos?' },
        ],
        dialogue: [
    ...
    studySections: [
      {
        ...
        vocabulary: [
          ...
          { term: 'enfrente de', translation: 'opposite' },
          { term: 'detrás de', translation: 'behind' },
          { term: 'en la esquina', translation: 'on the corner' },
          { term: 'en el semáforo', translation: 'at the traffic lights' },
          { term: 'la primera calle', translation: 'the first street' },
          { term: 'la segunda calle', translation: 'the second street' },
          { term: 'aquí / allí', translation: 'here / there' },
          { term: 'está lejos / cerca', translation: "it's far / close" },
          { term: '¿Está lejos?', translation: 'Is it far?' },
        ],
        dialogue: [
