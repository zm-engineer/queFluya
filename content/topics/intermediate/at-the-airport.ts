    ...
    studySections: [
      {
        ...
        vocabulary: [
          ...
          { term: 'departure / arrival', translation: 'salida / llegada' },
          { term: 'delayed / on time', translation: 'retrasado / a tiempo' },
          { term: 'the delay', translation: 'el retraso' },
          { term: 'window / aisle seat', translation: 'asiento de ventana / pasillo' },
          { term: 'to board', translation: 'embarcar' },
          { term: 'baggage claim', translation: 'recogida de equipaje' },
          { term: 'connection', translation: 'conexión / escala' },
    ...
    studySections: [
      {
        ...
        vocabulary: [
          ...
          { term: 'salida / llegada', translation: 'departure / arrival' },
          { term: 'retrasado / a tiempo', translation: 'delayed / on time' },
          { term: 'el retraso', translation: 'the delay' },
          { term: 'asiento de ventana / pasillo', translation: 'window / aisle seat' },
          { term: 'embarcar', translation: 'to board' },
          { term: 'la recogida de equipaje', translation: 'baggage claim' },
          { term: 'la conexión / escala', translation: 'connection' },
