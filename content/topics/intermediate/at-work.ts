    ...
    studySections: [
      {
        ...
        vocabulary: [
          ...
          { term: 'schedule', translation: 'horario' },
          { term: 'report', translation: 'informe' },
          { term: 'salary', translation: 'sueldo' },
          { term: 'overtime', translation: 'horas extra' },
          { term: 'remote work', translation: 'teletrabajo' },
          { term: 'a break', translation: 'un descanso' },
          { term: 'day off', translation: 'día libre' },
          { term: 'a raise', translation: 'un aumento' },
        ],
        dialogue: [
    ...
    studySections: [
      {
        ...
        vocabulary: [
          ...
          { term: 'el horario', translation: 'schedule' },
          { term: 'el informe', translation: 'report' },
          { term: 'el sueldo', translation: 'salary' },
          { term: 'las horas extra', translation: 'overtime' },
          { term: 'el teletrabajo', translation: 'remote work' },
          { term: 'un descanso', translation: 'a break' },
          { term: 'el día libre', translation: 'day off' },
          { term: 'un aumento', translation: 'a raise' },
        ],
        dialogue: [
